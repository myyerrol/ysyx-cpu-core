...
object Base {
    ...
    val ALU_TYPE_SRL  =  9.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_SRA  = 10.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_BEQ  = 11.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_BNE  = 12.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_BLT  = 13.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_BGE  = 14.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_BLTU = 15.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_BGEU = 16.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_JALR = 17.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_MUL  = 18.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_DIVU = 19.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_DIVW = 20.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_REMU = 21.U(SIGNAL_WIDTH.W)
    val ALU_TYPE_REMW = 22.U(SIGNAL_WIDTH.W)
